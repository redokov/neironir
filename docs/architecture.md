...
- `.docx`-конвертер сохраняет только параграфы, форматирование/таблицы/списки игнорируются. `Replacement`, пересекающий границу параграфов, выбрасывает `ValueError`.
